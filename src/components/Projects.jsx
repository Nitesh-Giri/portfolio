...
const projects = [
  {
    ...
    source: "https://github.com/Nitesh-Giri/Arogya-FrontEnd"
  },
  {
    ...
    source: "https://github.com/Nitesh-Giri/Suduko_Solver_Visualizer"
  },
  {
    title: "LPUSmartNotes",
    description: "This project developed a dedicated online platform tailored for LPU students, offering convenient access to academic resources such as lecture PPTs, handwritten notes, and previous five years' question papers.",
    image: "/images/LPUSmartNotes.png",
    tech: ["React", "TailwindCSS", "ExpressJS", "MongoDB", "NodeJS"],
    demo: "https://lpusmartnotes.onrender.com/",
    source: "https://github.com/Nitesh-Giri/LPUSmartNotes"
  }
];
