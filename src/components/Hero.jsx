      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-12 md:mb-0 animate-slide-in">
            <h1 className="text-5xl font-bold mb-4">Hi, I'm Nitesh Giri</h1>
            ...
            <div className="flex space-x-4 mb-6">
              {[
                { icon: Github, href: "https://github.com/Nitesh-Giri" },
                { icon: Linkedin, href: "https://www.linkedin.com/in/nitesh-giri/" },
                { icon: Mail, href: "mailto:niteshgiri068@gmail.com" },
              ].map(({ icon: Icon, href }) => (
                <a
                  key={href}
                  href={href}
            ...
            <div className="flex space-x-4">
              <a
                href="mailto:niteshgiri068@gmail.com"
